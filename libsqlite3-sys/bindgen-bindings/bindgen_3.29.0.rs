...
pub const SQLITE_VERSION: &[u8; 7] = b"3.29.0\0";
pub const SQLITE_VERSION_NUMBER: i32 = 3029000;
pub const SQLITE_SOURCE_ID: &[u8; 85] = b"2019-07-10 17:32:03 fc82b73eaac8b36950e527f12c4b5dc1e147e6f4ad2217ae43ad82882a88bfa6\0";
...
pub struct sqlite3_io_methods {
    ...
    pub xClose: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut sqlite3_file) -> ::std::os::raw::c_int,
    >,
    ...
    pub xShmBarrier: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut sqlite3_file),
    >,
...
pub type sqlite3_syscall_ptr = ::std::option::Option<unsafe extern "system" fn()>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct sqlite3_mem_methods {
    ...
    pub xFree: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut ::std::os::raw::c_void),
    >,
    ...
    pub xRoundup: ::std::option::Option<
        unsafe extern "system" fn(arg1: ::std::os::raw::c_int) -> ::std::os::raw::c_int,
    >,
...
extern "system" {
    pub fn sqlite3_create_function_v2(
        ...
        xFinal: ::std::option::Option<
            unsafe extern "system" fn(arg1: *mut sqlite3_context),
        >,
...
pub struct sqlite3_module {
    ...
    pub xDisconnect: ::std::option::Option<
        unsafe extern "system" fn(pVTab: *mut sqlite3_vtab) -> ::std::os::raw::c_int,
    >,
...
pub struct sqlite3_mutex_methods {
    pub xMutexInit: ::std::option::Option<
        unsafe extern "system" fn() -> ::std::os::raw::c_int,
    >,
    pub xMutexEnd: ::std::option::Option<
        unsafe extern "system" fn() -> ::std::os::raw::c_int,
    >,
    pub xMutexAlloc: ::std::option::Option<
        unsafe extern "system" fn(arg1: ::std::os::raw::c_int) -> *mut sqlite3_mutex,
    >,
    pub xMutexFree: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut sqlite3_mutex),
    >,
    pub xMutexEnter: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut sqlite3_mutex),
    >,
    pub xMutexTry: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut sqlite3_mutex) -> ::std::os::raw::c_int,
    >,
...
pub struct sqlite3_pcache_methods2 {
    ...
    pub xPagecount: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut sqlite3_pcache) -> ::std::os::raw::c_int,
    >,
    pub xFetch: ::std::option::Option<
        unsafe extern "system" fn(
            arg1: *mut sqlite3_pcache,
    ...
    pub xTruncate: ::std::option::Option<
        unsafe extern "system" fn(
            arg1: *mut sqlite3_pcache,
            iLimit: ::std::os::raw::c_uint,
        ),
    >,
    pub xDestroy: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut sqlite3_pcache),
    >,
    pub xShrink: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut sqlite3_pcache),
    >,
}
#[repr(C)]
...
pub struct Fts5ExtensionApi {
    ...
    pub xUserData: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut Fts5Context) -> *mut ::std::os::raw::c_void,
    >,
    pub xColumnCount: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut Fts5Context) -> ::std::os::raw::c_int,
    >,
    ...
    >,
    pub xRowid: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut Fts5Context) -> sqlite3_int64,
    >,
...
pub struct fts5_tokenizer {
    ...
    >,
    pub xDelete: ::std::option::Option<
        unsafe extern "system" fn(arg1: *mut Fts5Tokenizer),
    >,
    pub xTokenize: ::std::option::Option<
        unsafe extern "system" fn(
